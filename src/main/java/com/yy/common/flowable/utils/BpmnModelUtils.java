...
import com.yy.common.flowable.enums.BpmTriggerTypeEnum;
import com.yy.common.flowable.enums.BpmUserTaskRejectHandlerTypeEnum;
import com.yy.ppm.flowable.bean.dto.BpmSimpleModelDTO;
...
import static com.yy.common.flowable.constants.BpmnModelConstants.*;
...
public class BpmnModelUtils {
     ...
     * @param userTask 任务节点
     */
    public static void addTaskRejectElements(BpmSimpleModelDTO.RejectHandler rejectHandler, UserTask userTask) {
     ...
     * @param userTask 任务节点
     */
    public static void addAssignEmptyHandlerType(BpmSimpleModelDTO.AssignEmptyHandler emptyHandler, UserTask userTask) {
     ...
     * 给节点添加操作按钮设置元素
     */
    public static void addButtonsSetting(List<BpmSimpleModelDTO.OperationButtonSetting> buttonsSetting, UserTask userTask) {
     ...
     * @return 操作按钮设置
     */
    public static Map<Integer, BpmTaskDTO.OperationButtonSetting> parseButtonsSetting(BpmnModel bpmnModel, String flowElementId) {
        FlowElement flowElement = getFlowElementById(bpmnModel, flowElementId);
        if (flowElement == null) {
            return null;
        }
        ...
        Map<Integer, BpmTaskDTO.OperationButtonSetting> buttonSettings = Maps.newHashMapWithExpectedSize(extensionElements.size());
        extensionElements.forEach(element -> {
            ...
            if (StrUtil.isNotEmpty(id)) {
                BpmTaskDTO.OperationButtonSetting setting = new BpmTaskDTO.OperationButtonSetting();
...
//    public static void addListenerConfig(FlowableListener flowableListener, BpmSimpleModelDTO.ListenerHandler handler) {
...
//    }
    ...
    public static BpmSimpleModelDTO.ListenerHandler parseListenerConfig(Expression fixedValue) {
        String expressionText = fixedValue.getExpressionText();
        Assert.notNull(expressionText, "监听器扩展字段({})不能为空", expressionText);
        return JsonUtils.parseObject(expressionText, BpmSimpleModelDTO.ListenerHandler.class);
    }
