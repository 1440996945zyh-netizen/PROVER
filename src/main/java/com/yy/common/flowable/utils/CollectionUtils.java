...
//    }
    ...
    /**
     *  从对象集合中提取某一个属性，生成去重的 Set<String>
     * @param from
     * @param func
     * @return
     * @param <T>
    ...
    /**
     * 将对象集合转换为键值对映射
     * 将 List<User> 转换为 Map<Long, String>，Key 为 userId，Value 为 userName
     * Map<Long, String> userNameMap = convertMap(userList, User::getId, User::getName);
     * @param from
     * @param keyFunc
     * @return
     * @param <T>
