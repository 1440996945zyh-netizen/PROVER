...
import com.yy.ppm.flowable.bean.dto.BpmFormFieldDTO;
...
//    }
     ...
     * @return 摘要
     */
    public static List<KeyValue<String, String>> getSummary(BpmProcessDefinitionInfoPO processDefinitionInfo,
        ...
        if (ObjectUtil.isNotNull(processDefinitionInfo.getSummarySetting())
            ...
            return convertList(processDefinitionInfo.getSummarySetting().getSummary(), item -> {
                BpmFormFieldDTO formField = formFieldsMap.get(item);
                if (formField != null) {
