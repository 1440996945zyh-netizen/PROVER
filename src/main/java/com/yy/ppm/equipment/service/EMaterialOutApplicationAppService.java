 ...
 * @author system
 */
public interface EMaterialOutApplicationAppService {

    /**
     * 查询物资出库申请列表（分页）
     */
    Pages<EMaterialOutApplicationDTO> getList(EMaterialOutApplicationSearchDTO searchDTO, PageParameter parameter);
