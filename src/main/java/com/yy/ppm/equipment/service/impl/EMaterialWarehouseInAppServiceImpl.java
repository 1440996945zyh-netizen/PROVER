...
@Service
public class EMaterialWarehouseInAppServiceImpl implements EMaterialWarehouseInAppService {

    @Resource
    private EMaterialWarehouseInAppMapper mapper;

    @Resource
    private EMaterialWarehouseInDetailAppMapper detailMapper;
