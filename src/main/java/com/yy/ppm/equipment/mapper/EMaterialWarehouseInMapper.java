 ...
 * @author system
 */
public interface EMaterialWarehouseInMapper {
     ...
     */
    @Edit
    int insert(EMaterialWarehouseInPO po);

    /**
     * 修改物资入库
     */
    @Edit
    int update(EMaterialWarehouseInPO po);
    ...
    @Edit
    void updateStatus(EMaterialWarehouseInPO po);
}
