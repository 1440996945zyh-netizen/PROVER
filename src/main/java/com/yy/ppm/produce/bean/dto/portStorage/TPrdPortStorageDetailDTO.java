...
@Setter
@Getter
public class TPrdPortStorageDetailDTO{

	/**
	 * 
	 */
	private static final long serialVersionUID = 2323902150783878716L;
	...
	private String classCode; //作业班次
	private String className; //作业班次
    ...
    private String processOtherCode;
}
