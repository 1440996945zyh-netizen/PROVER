...
@Setter
@ToString
public class MWorkProcessPO extends BasePO implements Serializable {

    private static final long serialVersionUID = -54571432987287796L;
     ...
     * 是否改变货物包装
     */
    private String isCargoPackageChange;
