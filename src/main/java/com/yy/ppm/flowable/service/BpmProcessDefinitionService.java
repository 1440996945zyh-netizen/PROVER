...
public interface BpmProcessDefinitionService {
     ...
     * @return 流程定义 Page
     */
    Pages<ProcessDefinition> getProcessDefinitionPage(BpmProcessDefinitionInfoSearchDTO pageReqVO);
     ...
     * @return 流程编号
     */
    String createProcessDefinition(Model model, BpmModelMetaInfoDTO modelMetaInfo,
     ...
     * @return 流程定义信息
     */
    BpmProcessDefinitionInfoPO getProcessDefinitionInfo(String id);
     ...
     * @return 流程额定义信息数组
     */
    List<BpmProcessDefinitionInfoPO> getProcessDefinitionInfoList(Collection<String> ids);

    default Map<String, BpmProcessDefinitionInfoPO> getProcessDefinitionInfoMap(Set<String> ids) {
        return convertMap(getProcessDefinitionInfoList(ids), BpmProcessDefinitionInfoPO::getProcessDefinitionId);
    }
     ...
     * @return 是否可以发起流程
     */
    boolean canUserStartProcessDefinition(BpmProcessDefinitionInfoPO processDefinition, Long userId);
