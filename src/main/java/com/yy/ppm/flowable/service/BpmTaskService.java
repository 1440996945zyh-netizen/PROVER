...
public interface BpmTaskService {
     ...
     * @return 流程任务分页
     */
    Pages<Task> getTaskTodoPage(Long userId, BpmTaskSearchDTO pageReqVO);
     ...
     * @return 待办任务
     */
    BpmTaskDTO getTodoTask(Long userId, String taskId, String processInstanceId);
     ...
     * @return 流程任务分页
     */
    Pages<HistoricTaskInstance> getTaskDonePage(Long userId, BpmTaskSearchDTO pageReqVO);
     ...
     * @return 流程任务分页
     */
    Pages<HistoricTaskInstance> getTaskPage(Long userId, BpmTaskSearchDTO pageReqVO);
     ...
     * @param reqVO  通过请求
     */
    void approveTask(Long userId,BpmTaskApproveDTO reqVO);
     ...
     * @param reqVO  不通过请求
     */
    void rejectTask(Long userId, BpmTaskRejectDTO reqVO);
     ...
     * @param reqVO  分配请求
     */
    void transferTask(Long userId, BpmTaskTransferDTO reqVO);
     ...
     */
    void returnTask(Long userId, BpmTaskReturnDTO reqVO);
     ...
     */
    void delegateTask(Long userId, BpmTaskDelegateDTO reqVO);
     ...
     * @param reqVO  当前用户 ID
     */
    void createSignTask(Long userId, BpmTaskSignCreateDTO reqVO);
     ...
     */
    void deleteSignTask(Long userId, BpmTaskSignDeleteDTO reqVO);
     ...
     * @param reqVO  通过请求
     */
    void copyTask(Long userId, BpmTaskCopyDTO reqVO);
