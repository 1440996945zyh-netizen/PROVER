...
public interface BpmProcessInstanceService {
     ...
     * @return 流程实例的分页
     */
    Pages<HistoricProcessInstance> getProcessInstancePage(Long userId, BpmProcessInstanceSearchDTO pageReqVO);
     ...
     * @return 流程实例的进度
     */
    BpmApprovalDetailDTO getApprovalDetail(Long loginUserId, BpmApprovalDetailSearchDTO reqVO);
     ...
     * @return 下一个执行节点信息
     */
    List<BpmApprovalDetailDTO.ActivityNode> getNextApprovalNodes(Long loginUserId,BpmApprovalDetailSearchDTO reqVO);
     ...
     * @return BPMN 模型视图
     */
    BpmProcessInstanceBpmnModelViewDTO getProcessInstanceBpmnModelView(String id);
     ...
     * @return 实例的编号
     */
    ProcessInstance createProcessInstance(Long userId, BpmProcessInstanceDTO createReqVO);
...
//    String createProcessInstance(Long userId, @Valid BpmProcessInstanceCreateReqDTO createReqDTO);
     ...
     */
    void cancelProcessInstanceByStartUser(Long userId, BpmProcessInstanceCancelDTO cancelReqVO);
     ...
     * @param cancelReqVO 取消信息
     */
    void cancelProcessInstanceByAdmin(Long userId, BpmProcessInstanceCancelDTO cancelReqVO);
