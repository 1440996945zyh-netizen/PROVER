 ...
 */
public interface TBusHandoverlistUnloadService {
    ...
    String addUpdateHandoverList(TBusHandoverListUnloadReqDTO dto);

    boolean isHaveTrust(Long cargoInfoId);

    boolean checkHaveTrust(Long voyageId);
}
