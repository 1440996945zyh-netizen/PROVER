 ...
 * @author makejava
 * @version 1.0.0
 * @ClassName (TSdInvoiceRequestItem)PO
 * @Description
 * @createTime 2024年11月07日 10:15:00
 */
@Data
public class TSdInvoiceRequestItemPO extends BasePO implements Serializable {

    private static final long serialVersionUID = -81413064846847593L;
