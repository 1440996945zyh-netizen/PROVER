...
public interface TallyReservationMapper {
...
//    Page<AppTallyCoilNumDTO> getNumber(AppTallyCoilNumDTO appTallyCoilNumDTO);
    ...
    @Edit
    void updateStatus(TBusReservationPoundPO tBusReservationPoundPO);

    @Edit
    void updateStatus2(TBusReservationPoundPO tBusReservationPoundPO);
    TBusReservationPoundPO getByPlanId(@Param("planId") String planId);
