...
public class TYardTallyPO extends BasePO {
     ...
     * 作业过程代码
     */
    @NotBlank(message ="作业过程代码不能为空")
    private String processCode;

    /**
     * 作业过程名称
     */
    @NotBlank(message ="作业过程名称不能为空")
    ...
    private Long deptParentId;//公司部门id
    private String deptParentName;//公司部门名称
    private String tallyStatus;
    private String isZd;
    private String isCrk;
    private String isFinished;
    private String weighOutDt;
    private Boolean bhName;
