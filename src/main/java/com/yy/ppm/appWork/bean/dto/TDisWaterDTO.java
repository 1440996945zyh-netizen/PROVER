...
@Setter
@ToString
public class TDisWaterDTO extends BasePO {
    ...
    private Long powerOnUserId;
    private Long powerDisUserId;
    private String powerOnUserName;
    private String powerDisUserName;
    private Integer ratio;
    private BigDecimal magni;
