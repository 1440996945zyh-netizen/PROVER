...
import com.yy.framework.exception.InnerConcurrentException;
...
public final class DistributedReentrantLock {
    ...
    public static class Builder {
        ...
        public DistributedReentrantLock build() {
            ...
            return new DistributedReentrantLock(this);
        }
    }
    ...
    private static final ThreadLocal<Queue<String>> KEYS = ThreadLocal.withInitial(() -> Collections.asLifoQueue(new ArrayDeque<>()));

    private DistributedReentrantLock(Builder builder) {
    ...
    public void run(Runnable runnable) {
        ...
        try {
            ...
            try {
                ...
                throw new InnerConcurrentException(e);
            }
        } catch (Exception e) {
            exception = e;
            throw e;
    ...
    private void before() {
        ...
        boolean bool = result != null ? result : false;
        if (!bool) {
