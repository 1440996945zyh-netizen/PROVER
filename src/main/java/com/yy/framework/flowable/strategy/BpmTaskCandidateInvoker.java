package com.yy.framework.flowable.strategy;
...
import static com.yy.common.flowable.constants.ErrorCodeConstants.MODEL_DEPLOY_FAIL_TASK_CANDIDATE_NOT_CONFIG;
...
//    }
    ...
    void removeDisableUsers(Set<Long> assigneeUserIds) {
        ...
        Map<Long, SysUserDTO> userMap = sysUserService.getUserMap(assigneeUserIds);
        assigneeUserIds.removeIf(id -> {
            SysUserDTO user = userMap.get(id);
            return user == null || CommonStatusEnum.isDisable(user.getStatus().intValue());
        });
    }
