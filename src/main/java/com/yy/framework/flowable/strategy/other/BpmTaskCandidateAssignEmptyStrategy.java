package com.yy.framework.flowable.strategy.other;

import cn.hutool.core.lang.Assert;
import com.yy.common.flowable.enums.BpmTaskCandidateStrategyEnum;
import com.yy.common.flowable.enums.BpmUserTaskAssignEmptyHandlerTypeEnum;
...
/**
 * 审批人为空 {@link com.yy.framework.flowable.strategy.BpmTaskCandidateStrategy} 实现类
 *
 * @author kyle
 */
@Component
public class BpmTaskCandidateAssignEmptyStrategy implements BpmTaskCandidateStrategy {
    ...
    private Set<Long> getCandidateUsers(String processDefinitionId, FlowElement flowElement) {
        ...
        if (Objects.equals(assignEmptyHandlerType, BpmUserTaskAssignEmptyHandlerTypeEnum.ASSIGN_ADMIN.getType())) {
            BpmProcessDefinitionInfoPO processDefinition = processDefinitionService.getProcessDefinitionInfo(processDefinitionId);
