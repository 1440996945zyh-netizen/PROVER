package com.yy.framework.flowable.redis;

import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import com.yy.common.flowable.constants.RedisKeyConstants;
...
public class BpmProcessIdRedisDAO {
     ...
     * @return 序号
     */
    public String generate(BpmModelMetaInfoDTO.ProcessIdRule processIdRule) {
        // 生成日期前缀
        String infix = "";
